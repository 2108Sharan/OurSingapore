...
public class CustomAdapter extends ArrayAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tvName = rowView.findViewById(R.id.textViewName1);
        TextView tvSqKM = rowView.findViewById(R.id.textViewSqKM);
        ...
        tvSqKM.setText(Integer.toString(currentVersion.getSqKM()));
